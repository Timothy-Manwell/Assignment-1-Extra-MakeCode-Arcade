namespace SpriteKind {
    export const soulCoin = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.soulCoin, function (sprite, otherSprite) {
...
function startLevel () {
    ...
    tiles.placeOnTile(Skully, tiles.getTileLocation(0, 9))
...
Skully = sprites.create(img`
    ...
    `, SpriteKind.Player)
tiles.setCurrentTilemap(tilemap`level1`)
controller.moveSprite(Skully, 90, 0)
Skully.ay = 200
startLevel()
for (let index = 0; index < 100; index++) {
    music.playMelody("G A B F C G D E ", 120)
}
